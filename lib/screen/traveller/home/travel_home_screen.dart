...
import 'package:coolie_passanger/screen/traveller/home/travel_home_controller.dart';
    ...
    return GetBuilder<TravelHomeController>(
      ...
      return WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            title: Text("Passenger Dashboard", style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text("OTP :", style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold),),
                        Text("2345", style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w500),)
                      ],
                    ),
                  ),
                ),
          ...
          floatingActionButton: FloatingActionButton.extended(
            onPressed: (){
              controller.bookCoolieDetails();
            }, label: Text("Book Coolie"),
          ),
        ),
      );
    });
      ...
      child: Column(
        children: [
          UserAccountsDrawerHeader(
            ...
            accountEmail: Text(
              controller.userProfile.value.user?.mobileNo ?? "",
              style: GoogleFonts.poppins(),
            ),
